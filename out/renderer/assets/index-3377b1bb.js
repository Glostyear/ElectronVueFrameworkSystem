...
const request = axios$1.create({
  baseURL: "http://uat.crm.xuexiluxian.cn"
});
...
const _sfc_main = {
  __name: "Home",
  setup(__props) {
    console.log({ "RENDERER_NODE_ENV": "development", "RENDERER_VUE_APP_PROXY": "true", "RENDERER_VUE_APP_API_BASEURL": "http://uat.crm.xuexiluxian.cn", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false });
    const login = () => {
      userLogin({
        username: "admin",
        password: "admin",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        createBaseVNode("button", { onClick: login }, "登录")
      ]);
    };
  }
};
const router = createRouter({
  ...
  //hash模式
  routes: [{ path: "/", component: _sfc_main }]
  //路由配置规则数组
});
var isVue2 = false;
/*!
